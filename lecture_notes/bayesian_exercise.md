...
2024-04-04: In class computer lab tutorial on MrBayes 
(Note: don't have homebrew on laptop due it requiring Intel architecture, doesn't run on M2 chip, will run on lab desktop)

Note: want ngen to be at least 1 million when running on real data. 
### MrBayes (non-edited from crls github tutorial)
